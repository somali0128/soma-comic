  ...
  toolsPage: {
    ...
    items: {
      ...
      heartRateBattle: {
        ...
        status: 'OBS 实时心率浏览器源',
        description:
          '一款可高度自定义的双人心率对决 OBS 浏览器源，可读取两名玩家的实时心率，并在每个回合结束时比较平均 BPM。',
        details: ['支持 JSON HTTP、WebSocket、Pulsoid 和 HypeRate', '自动采样、重连并排除无效或过期数据', '透明背景，适配横屏与竖屏直播布局'],
        linkLabel: '查看 heart-rate-battle 仓库',
      },
    },
  },
};
